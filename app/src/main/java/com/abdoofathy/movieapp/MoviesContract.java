...
public final class MoviesContract {
    ...
    public static final String SQL_CREATE_FAVOURITE_MOVIES =
            "CREATE TABLE " + MovieEntry.TABLE_NAME + " (" +
                    ...
                    MovieEntry.COLUMN_NAME_RELEASE_DATE + TEXT_TYPE + " NOT NULL" +
            " )";

//    public static final String SQL_DELETE_FAVOURITE_MOVIES =
